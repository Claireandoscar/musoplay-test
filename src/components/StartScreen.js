...
const StartScreen = ({ onStartGame }) => {
  ...
  const infoBlocks = [
    ...
    "YOUR PARTICIPATION AND FEEDBACK IS IMPORTANT TO SHAPING THE FUTURE MUSOPLAY.\nTHANK YOU FOR TAKING PART!",
    "WHEN LAUNCHED, MUSOPLAY WILL CHALLENGE YOU WITH A NEW MELODY/GAME DAILY",
    "TODAY'S TEST VERSION HAS THREE MELODIES/GAMES EACH AT A DIFFERENT LEVEL OF DIFFICULTY",
    "YOUR PREFERENCES WILL GUIDE HOW FUTURE MELODIES AND OTHER ELEMENTS OF MUSOPLAY ARE CRAFTED",
